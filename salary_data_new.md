...
This piece of code install the 'tidyverse' package and loads it to be used.
...
We don't want dirty data! Time take an overlook at the data to check how its consistency.
...
First graph baby.
Let's take a look on the average salary by continent.
